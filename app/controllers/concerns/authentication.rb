module Authentication
  ...
  class_methods do
    ...
    def unauthenticated_access_only(**options)
      ...
      before_actin -> { redirect_to root_path if authenticated? }, **options
    end
  end
  ...
  def after_authentication_url
    session.delete(:return_to_after_authenticating) || (Current.account&.admin? ? admin_root_url : root_url)
  end
